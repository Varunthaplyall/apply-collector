...
#
# Total image size: ~400MB  |  Runtime memory: ~250MB (fits Render free 512MB)
...
RUN pip install --no-cache-dir \
        ...
        "playwright>=1.40" "pydantic>=2.0" "python-dotenv>=1.0" \
        "psycopg2-binary>=2.9" "supabase>=2.0" "flask>=3.0" "pyjwt>=2.9" \
        "sentence-transformers>=3.0" "pgvector>=0.3"
